    ...
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            while (continuar) {
                ...
                System.out.println("3. Editar link de un evento");
                ...
                switch (opcion) {
                    ...
                    case "3":
                        mostrarEventos(eventos);
                        System.out.print("Selecciona el número del evento para cambiar el link: ");
                        int indiceLink = leerIndice(sc, eventos.size());
                        if (indiceLink != -1) {
                            System.out.print("Ingresa el nuevo link: ");
                            String nuevoLink = sc.nextLine().trim();
                            if (!nuevoLink.isEmpty()) {
                                eventos.get(indiceLink).setLink(nuevoLink);
                                System.out.println("✅ Link actualizado con éxito.");
                            } else {
                                System.out.println("❌ Link no puede estar vacío.");
                            }
                        }
                        break;
